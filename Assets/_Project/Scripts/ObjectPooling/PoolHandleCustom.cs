...
public sealed class PoolHandleCustom
{
    ...
    public T Spawn<T>(T type, Transform parent = null, bool worldPositionStays = true, bool initialize = true,
        ...
        where T : Component
    {
        return Spawn(type.gameObject, parent, worldPositionStays, initialize, initAction).GetComponent<T>();
    }
    ...
    public T Spawn<T>(T type, Vector3 position, Quaternion rotation, Transform parent = null,
        ...
        where T : Component
    {
        return Spawn(type.gameObject, position, rotation, parent, worldPositionStays, initialize, initAction)
            .GetComponent<T>();
    }
